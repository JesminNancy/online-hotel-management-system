        ...
        <div class="row">
                ...
                <div class="col-lg-8 col-md-6 checkout-left mb_30">
                    ...
                    <div class="stripe mt_20">
                        ...
                        @php
                            ...
                            $stripe_Publishable_key = 'pk_test_51Nmvw7IVBsGr3p0v2LNor0giFrJ5XIdV9QAyVNt64mqQ2FeqeVZINW2pTotVGYwcGx3LK70gtRJow3otJOqteSgO00KESMy88J';
                        @endphp
            ...
            <div class="col-lg-4 col-md-6 checkout-right">
                <div class="inner">
                    ...
                    <div>
                        Address: {{ session()->get('billing_email') }}
                    </div>
                    <div>
                                        ...
                                        for ($i=0; $i<count($arr_cart_room_id); $i++) {
                                            ...
                                            <tr>
                                                <td>
                                                    {{ $room_data->name }}
                                                    <br>
                                                    ({{ $arr_cart_checkin[$i] }} - {{ $arr_cart_checkout[$i] }})
                                                    <br>
