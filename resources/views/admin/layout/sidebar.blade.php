<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('/admin/datewise_rooms') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_datewise_rooms') }}"><i class="fa fa-calendar"></i> <span>Datewise Rooms</span></a></li>
            ...
            <li class="{{ Request::is('admin/customers') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_customer') }}"><i class="fa fa-user"></i> <span>Customers</span></a></li>

            <li class="{{ Request::is('admin/orders') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_orders') }}"><i class="fa fa-cart-plus"></i> <span>Orders</span></a></li>

            <li class="{{ Request::is('admin/slider/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_slider_view') }}"><i class="fa fa-cubes"></i> <span>Slider</span></a></li>
            ...
            <li class="{{ Request::is('admin/fqa/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_fqa_view') }}"><i class="fa fa-bolt"></i> <span>FQA</span></a></li>
        </ul>
    </aside>
</div>
