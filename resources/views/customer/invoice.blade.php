        ...
        <div class="invoice-print">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <address>
                                ...
                                {{ Auth::guard('customer')->user()->city }},{{ Auth::guard('customer')->user()->country }}
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    ...
                    <p class="section-lead">Hotel room information in details</p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-md">
                            <tr>
                                ...
                                <th class="text-center">Checkou Date</th>
